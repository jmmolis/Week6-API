...
import edu.du.week6apis.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun postMethod() {
        ...
        fun rawJSON() {
            ...
            // Create RequestBody ( not using any converter, use RequestBody )
            val requestBody = jsonObjectString.toRequestBody("application/json".toMediaTypeOrNull())

            CoroutineScope(Dispatchers.IO).launch {
                // Do the POST request and get response
                val response = service.createDog(requestBody)
                ...
                withContext(Dispatchers.Main) {
                    if (response.isSuccessful) {
                        ...
                        Log.w("Pretty Printed JSON - ", prettyJson)
        ...
        fun formData() {
            ...
            fields["email"] = ("test@email.com").toRequestBody("text/plain".toMediaTypeOrNull())
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                // Do the POST request and get response
                val response = service.uploadDogData(fields)
        ...
        fun urlEncoded() {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                // Do the POST request and get response
                val response = service.createDog(params)
        ...
        fun getMethod() {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                /*
             * For @Query: You need to replace the following line with val response = service.getDogs(2)
             * For @Path: You need to replace the following line with val response = service.getDog(53)
             */

                // Do the GET request and get response
                val response = service.getDogs()
        ...
        fun putMethod() {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                val response = service.updateDog(requestBody)
        ...
        fun deleteMethod() {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                // Do the DELETE request and get response for adopted dogs

                val response = service.deleteDog()
                withContext(Dispatchers.Main) {
                    if (response.isSuccessful) {
